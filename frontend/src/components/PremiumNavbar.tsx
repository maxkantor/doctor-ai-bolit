    ...
    const loadUsage = async () => {
      try {
        ...
        if (typeof remaining === 'object' && 'creditBalance' in remaining) {
          ...
          const chatRemaining = remaining.remainingMessages || 0
          ...
          if (chatRemaining >= UNLIMITED_MESSAGES_THRESHOLD) {
            ...
            setUsageText(`${chatRemaining}/${safeDenominator}`)
            setUsageTooltip(`${chatRemaining} of ${safeDenominator} purchased messages remaining`)
          } else {
