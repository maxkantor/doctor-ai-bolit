...
export class DoctorAibolitStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const backendBuildPath = path.join(__dirname, '../../../backend/bin/Release/net10.0/linux-x64/publish');
    const lambdaFunction = new lambda.Function(this, 'DoctorAibolitApi', {
      ...
      environment: {
        ...
        // Defaults to production domain. To override:
        // Deploy with context: cdk deploy -c baseUrl=https://yourdomain.com
