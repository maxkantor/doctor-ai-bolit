...
public interface IOpenAIService
{
    ...
    Task<string> GeneratePhotoGuidanceAsync(string userMessage, byte[] imageBytes, string imageContentType, List<ChatMessage> conversationHistory, CancellationToken cancellationToken = default);
